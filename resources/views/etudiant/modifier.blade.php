    ...
    <div class="card">
      ...
      <div class="card-body">
        <form method="post" action="/modifier/traitement">
          @csrf
          <input name="id" type="hidden" value="{{ $etudiant->id ?? 'None' }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Prénom" name="prenom" value="{{ $etudiant->prenom ?? 'None' }}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="code_f">Filière</label>
            <input type="text" class="form-control" placeholder="Filière" name="code_f" value="{{ $etudiant->code_f ?? 'None' }}">
          </div>
